...
// // script.js
// function simulateWakeWordDetection() {
//     // Simulate wake word detection
//     setTimeout(() => {
//         console.log("Simulated wake word detected!");
//         // You can make a POST request to your server to set the wake word detected status
//         fetch('http://192.168.29.102:5004/reset_status', {
//             method: 'POST',
//             headers: {
...
// // Periodically check for wake word detection
// setInterval(simulateWakeWordDetection, 10000); // Check every 10 seconds
...
window.addEventListener('load', () => {
    ...
    // Initialize other features (like the assistant) here
});
...
function toggleMoreQuestions() {
    ...
    seeMoreButton.textContent = moreQuestions.classList.contains('hidden') ? 'See More' : 'See Less';
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    seeMoreBtn.addEventListener('click', () => {
        moreQuestions.classList.toggle('show');
        if (moreQuestions.classList.contains('show')) {
...
// Function to handle speech commands
function takeCommand(command) {
    console.log("Command received: ", command); // Debugging line
    const wakeWords = ['hey sharma', 'sharma', 'hi sharma', 'hey', 'hi'];
    
    if (wakeWords.some(wakeWord => command.includes(wakeWord))) {
        console.log("Wake word detected"); // Debugging line
        speak("How can I assist you?");
        // Add more functionality based on commands here
    } else {
        console.log("No wake word detected, or command not recognized."); // Debugging line
    }
}
...
recognition.onresult = (event) => {
    ...
    // Optionally, stop recognition after processing the command
    // recognition.stop();
};

recognition.onspeechend = () => {
    console.log("Speech ended, restarting..."); // Debugging line
...
const basicQuestions = [
        "hi","hey sharma", "sharma", "hi sharma", "hey", "hello", "good morning", "good afternoon", "good evening", "thank you", "education", "skill", "skills", "experience", 
...
function getBasicResponse(question) {
    ...
    switch(normalizedQuestion) {
        ...
        case "experience":
            return "I have more than 1.5 year of experience working as a Java Backend Developer.";
...
function takeCommand(message) {
    ...
    // Handle social network profiles with alternative phrasing
             ...
             message.includes("his linkedin") || message.includes("prabhat's linkedin") || message.includes("show his linkedin profile") ||
             message.includes("see linkedin") || message.includes("explore linkedin") ||  message.includes("explore his linkedin") ||
             message.includes("i want to see his linkedin") || message.includes("i want to explore his linkedin") || message.includes("show his linkedin") ||
    ...
    } else if (message.includes("leetcode") || message.includes("leetcode profile") || message.includes("leet code profile") || message.includes("show his leetcode profile") ||
             message.includes("his leetcode") || message.includes("prabhat's leetcode") ||  message.includes("explore his leetcode") ||
             message.includes("see leetcode") || message.includes("explore leetcode") || message.includes("show me lit code profile") ||
             message.includes("i want to see his leetcode") || message.includes("i want to explore his leetcode") || message.includes("show his leetcode") ||
        ...
        openSocialLink("leetcode");
             ...
             message.includes("his github") || message.includes("prabhat's github") || message.includes("show his github") || message.includes("show his github profile") ||
             message.includes("see github") || message.includes("explore github") || message.includes("explore his github") ||
    ...
    } else if (message.includes("stackoverflow") || message.includes("stackoverflow profile") || message.includes("stack overflow") || message.includes("show his stackoverflow profile") ||
             message.includes("his stackoverflow") || message.includes("prabhat's stackoverflow") ||  message.includes("explore his stackoverflow") ||
             message.includes("see stackoverflow") || message.includes("explore stackoverflow") || message.includes("explore stack overflow") ||
             message.includes("i want to see his stackoverflow") || message.includes("i want to explore his stackoverflow") || message.includes("show his stackoverflow") ||
             message.includes("stack over flow") || message.includes("stack over flow profile") || message.includes("stack over flow") || 
             message.includes("show his stack over flow profile") || message.includes("his stack over flow") || message.includes("prabhat's stack over flow") || 
             message.includes("explore his stack over flow") || message.includes("see stack over flow") || message.includes("explore stack over flow") || 
             message.includes("i want to see his stack over flow") || message.includes("i want to explore his stack over flow") || 
             message.includes("show his stack over flow") || message.includes("i want to see prabhat's stack over flow") || message.includes("i want to explore prabhat's stack over flow") ||
             message.includes("stack overflow") || message.includes("stack overflow profile") || message.includes("stack overflow") || 
             message.includes("show his stack overflow profile") || message.includes("his stack overflow") || message.includes("prabhat's stack overflow") || 
             message.includes("explore his stack overflow") || message.includes("see stack overflow") || message.includes("explore stack overflow") || 
             message.includes("i want to see his stack overflow") || message.includes("i want to explore his stack overflow") || 
             message.includes("show his stack overflow") || message.includes("i want to see prabhat's stack overflow") || message.includes("i want to explore prabhat's stack overflow") ||
             message.includes("stackover flow") || message.includes("stackover flow profile") || message.includes("stackover flow") || 
             message.includes("show his stackover flow profile") || message.includes("his stackover flow") || message.includes("prabhat's stackover flow") || 
             message.includes("explore his stackover flow") || message.includes("see stackover flow") || message.includes("explore stackover flow") || 
             message.includes("i want to see his stackover flow") || message.includes("i want to explore his stackover flow") || 
             message.includes("show his stackover flow") || message.includes("i want to see prabhat's stackover flow") || message.includes("i want to explore prabhat's stackover flow") ||
        ...
        openSocialLink("stackoverflow");
             ...
             message.includes("his naukri") || message.includes("prabhat's naukri") ||  message.includes("show his naukari") ||
             message.includes("see naukri") || message.includes("explore naukri") || message.includes("explore his naukari") ||
        ...
        openSocialLink("naukri");
             ...
             message.includes("his instagram") || message.includes("prabhat's instagram") ||  message.includes("show his instagram") ||
             message.includes("see instagram") || message.includes("explore instagram") || message.includes("explore his instagram") ||
        ...
        openSocialLink("instagram");
             ...
             message.includes("his twitter") || message.includes("prabhat's twitter") || message.includes("show his twitter") ||
             message.includes("see twitter") || message.includes("explore twitter") ||   message.includes("explore his twitter") ||
        ...
        openSocialLink("twitter");
             ...
             message.includes("his geeksforgeeks") || message.includes("prabhat's geeksforgeeks") || message.includes("show his geeksforgeeks") ||
             message.includes("see geeksforgeeks") || message.includes("explore geeksforgeeks") ||  message.includes("explore his geeksforgeeks") ||
             message.includes("i want to see his geeksforgeeks") || message.includes("i want to explore his geeksforgeeks") || message.includes("geek for geeks") || message.includes("geek for geeks profile") || message.includes("gfg profile") || 
             message.includes("his geek for geeks") || message.includes("prabhat's geek for geeks") || message.includes("show his geek for geeks") || 
             message.includes("see geek for geeks") || message.includes("explore geek for geeks") || message.includes("explore his geek for geeks") || 
             message.includes("i want to see his geek for geeks") || message.includes("i want to explore his geek for geeks") || 
             message.includes("i want to see prabhat's geek for geeks") || message.includes("i want to explore prabhat's geek for geeks") ||
             
             message.includes("geeks for geeks") || message.includes("geeks for geeks profile") || message.includes("gfg profile") || 
             message.includes("his geeks for geeks") || message.includes("prabhat's geeks for geeks") || message.includes("show his geeks for geeks") || 
             message.includes("see geeks for geeks") || message.includes("explore geeks for geeks") || message.includes("explore his geeks for geeks") || 
             message.includes("i want to see his geeks for geeks") || message.includes("i want to explore his geeks for geeks") || 
             message.includes("i want to see prabhat's geeks for geeks") || message.includes("i want to explore prabhat's geeks for geeks") ||
             
             message.includes("geek for geeks") || message.includes("geek for geeks profile") || message.includes("gfg profile") || 
             message.includes("his geek for geeks") || message.includes("prabhat's geek for geeks") || message.includes("show his geek for geeks") || 
             message.includes("see geek for geeks") || message.includes("explore geek for geeks") || message.includes("explore his geek for geeks") || 
             message.includes("i want to see his geek for geeks") || message.includes("i want to explore his geek for geeks") || 
             message.includes("i want to see prabhat's geek for geeks") || message.includes("i want to explore prabhat's geek for geeks") ||
             
             message.includes("geeks for geek") || message.includes("geeks for geek profile") || message.includes("gfg profile") || 
             message.includes("his geeks for geek") || message.includes("prabhat's geeks for geek") || message.includes("show his geeks for geek") || 
             message.includes("see geeks for geek") || message.includes("explore geeks for geek") || message.includes("explore his geeks for geek") || 
             message.includes("i want to see his geeks for geek") || message.includes("i want to explore his geeks for geek") || 
             message.includes("i want to see prabhat's geeks for geek") || message.includes("i want to explore prabhat's geeks for geek") ||
             
             message.includes("geekfor geeks") || message.includes("geekfor geeks profile") || message.includes("gfg profile") || 
             message.includes("his geekfor geeks") || message.includes("prabhat's geekfor geeks") || message.includes("show his geekfor geeks") || 
             message.includes("see geekfor geeks") || message.includes("explore geekfor geeks") || message.includes("explore his geekfor geeks") || 
             message.includes("i want to see his geekfor geeks") || message.includes("i want to explore his geekfor geeks") || 
             message.includes("i want to see prabhat's geekfor geeks") || message.includes("i want to explore prabhat's geekfor geeks") ||
             
             message.includes("geek forgeek") || message.includes("geek forgeek profile") || message.includes("gfg profile") || 
             message.includes("his geek forgeek") || message.includes("prabhat's geek forgeek") || message.includes("show his geek forgeek") || 
             message.includes("see geek forgeek") || message.includes("explore geek forgeek") || message.includes("explore his geek forgeek") || 
             message.includes("i want to see his geek forgeek") || message.includes("i want to explore his geek forgeek") || 
             message.includes("i want to see prabhat's geek forgeek") || message.includes("i want to explore prabhat's geek forgeek") ||
             
             message.includes("geek forgeeks") || message.includes("geek forgeeks profile") || message.includes("gfg profile") || 
             message.includes("his geek forgeeks") || message.includes("prabhat's geek forgeeks") || message.includes("show his geek forgeeks") || 
             message.includes("see geek forgeeks") || message.includes("explore geek forgeeks") || message.includes("explore his geek forgeeks") || 
             message.includes("i want to see his geek forgeeks") || message.includes("i want to explore his geek forgeeks") || 
             message.includes("i want to see prabhat's geek forgeeks") || message.includes("i want to explore prabhat's geek forgeeks") ||
             
             message.includes("geeksfor geek") || message.includes("geeksfor geek profile") || message.includes("gfg profile") || 
             message.includes("his geeksfor geek") || message.includes("prabhat's geeksfor geek") || message.includes("show his geeksfor geek") || 
             message.includes("see geeksfor geek") || message.includes("explore geeksfor geek") || message.includes("explore his geeksfor geek") || 
             message.includes("i want to see his geeksfor geek") || message.includes("i want to explore his geeksfor geek") || 
             message.includes("i want to see prabhat's geeksfor geek") || message.includes("i want to explore prabhat's geeksfor geek") ||             
        ...
        openSocialLink("geeksforgeeks");
             ...
             message.includes("his hackerrank") || message.includes("prabhat's hackerrank") || message.includes("show his hackerrank") ||
             message.includes("see hackerrank") || message.includes("explore hackerrank") ||  message.includes("explore his hackerrank") ||
        ...
        openSocialLink("hackerrank");
             ...
             message.includes("his resume") || message.includes("prabhat's resume") || message.includes("show his resume") ||
             message.includes("see resume") || message.includes("explore resume") ||  message.includes("explore his resume") ||
